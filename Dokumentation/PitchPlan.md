## Andromeda: Pitch-Präsentation

## Phase 1: Der Hook & Das Intro (Intrigue Frame)

> *[Bühnenanweisung]*
> 
> *Auf dem Bildschirm ist nur eine statische, minimalistische Grafik zu sehen. Du gehst entspannt in die Mitte der Bühne. Du schaust ins Publikum, machst eine kurze Pause, bis absolute Stille herrscht. Du ignorierst den Klicker in deiner Hand.*

**Gabriel:**

"Hey Andromeda. Starte die Präsentation."

> *[Bühnenanweisung]*
> 
> *Die Präsentation startet automatisch.*

**Gabriel:**

"Wir interagieren mit unseren Hochleistungsrechnern heute noch fast genauso wie vor 30 Jahren. Wir tippen. Wir klicken. Wir suchen in Menüs.

Wir alle kennen Siri, Alexa oder Cortana. Aber seien wir ehrlich: Das sind geschlossene Systeme. Sie sind gut darin, uns das Wetter zu verraten. Aber wenn es um echte, komplexe Produktivität am Windows-Rechner geht? Da versagen sie. Sie zwingen uns ihre Logik auf.

Was wäre, wenn nicht Sie sich an den Assistenten anpassen müssten – sondern der Assistent sich an Sie?

Willkommen bei Andromeda."

## Phase 2: Das Problem & Die Vision (The Big Idea)
...
## Phase 3: Die Lösung & Die USPs (The Analytical Brain)
...
## Phase 4: Das Team (The Execution Frame)

**Gabriel:**

"Eine solche Plattform baut sich nicht von selbst. Ideen sind billig, Execution ist alles. Das Team, das diese Vision gerade Realität werden lässt, besteht aus drei Kernpersonen:

- **Gabriel Pabst:** Ich, Gabriel Pabst, bin unser Head-Programmer und Lead. Ich bin somit der architektonische Kopf hinter der Software und treibe die technische Vision voran.

- **Pia Graf:** Ich, Pia Graf, bin verantwortlich für Backend und Design. Ich sorge dafür, dass die komplexe Daten-Logik im Hintergrund nahtlos mit einer intuitiven, sauberen Nutzererfahrung verschmilzt.

- **Kinga Grad:** Ich, Kinga Grad, vereine Backend- und Design-Expertise und bin zudem unser Scrum Master. Ich bin dafür verantwortlich, dass unsere Entwicklungszyklen rasant, agil und ohne Reibungsverluste ablaufen.

Wir sind ein Team von Entwicklern, die genau das Produkt bauen, auf das wir selbst seit Jahren warten."

---

## Phase 5: Das Business Modell (The Deal)

**Gabriel:**

"Technologie ist das eine, Skalierbarkeit das andere. Wie verdienen wir damit Geld? Wir verkaufen Andromeda über ein hybrides Lizenzmodell kombiniert mit Tokens.
