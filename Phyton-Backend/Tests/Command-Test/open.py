...
def get_install_path_from_where(app_name):
    """
...
def search_common_install_paths(app_name):
    """
    ...
    """
    for base_dir in COMMON_INSTALL_LOCATIONS:
...
def get_install_path_from_registry(app_name):
    """
...
def get_installation_path(app_name):
    """
...
def open_application(app_name):
    ...
    """
    path = get_installation_path(app_name)
