...
pathToSysCommandList = os.path.join(BASE_DIR, "modules", "ExecuterClient", "sysCommandList.json")
pathToCustomCommandList = os.path.join(BASE_DIR, "modules", "ExecuterClient", "customCommandList.json")
